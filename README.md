...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-khjh6cu.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-khjh6cu.containers.anotherwebservice.com/
...
```
git clone git@github.com:tintupratap/container-khjh6cu.git
cd container-khjh6cu
```
...
```
docker attach container-khjh6cu
```
